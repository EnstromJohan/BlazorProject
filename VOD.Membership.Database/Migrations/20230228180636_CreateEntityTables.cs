    ...
    public partial class CreateEntityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimilarFilm", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SimilarFilmsId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Films", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Films_SimilarFilm_SimilarFilmsId",
                        column: x => x.SimilarFilmsId,
                        principalTable: "SimilarFilm",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Films_SimilarFilmsId",
                table: "Films",
                column: "SimilarFilmsId");
        }
